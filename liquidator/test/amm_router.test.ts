...
const generateRandomPoolAsset =(
    ...
    amount: string = Math.random().toString()) : Coin => {
...
describe('Osmosis Router Tests', () => {
    ...
    test('We can find the two separate routes', ()=> {
        ...
        const pools = [
            ...
            generateRandomPool(),
            generateRandomPool(
                [generateRandomPoolAsset(osmoDenom), generateRandomPoolAsset(shitDenom)]

            ),
            generateRandomPool(),
            generateRandomPool(
                [generateRandomPoolAsset(shitDenom), generateRandomPoolAsset(stableDenom)]
            ),
            generateRandomPool(),
            generateRandomPool(),
            generateRandomPool()
